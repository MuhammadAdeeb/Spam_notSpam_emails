...
if __name__ == '__main__':
    ...
    # s_c, as_ps, as_pns
    # ns_c, ans_ps, ans_pns
    as_ps = 0  # Actual spam, predicted spam. Update this:  1; delivered to spam, True Negative
    as_pns = 0  # Actual spam, predicted not-spam. Update this:  1; delivered to inbox, False Positive
    ans_ps = 0  # Actual not-spam, predicted spam. Update this:  2; delivered to spam, False Negative
    ans_pns = 0  # # Actual not-spam, predicted not-spam. Update this:  2; delivered to inbox, True Positive

    as_ps, as_pns, ans_ps, ans_pns = cm.ravel()

    accuracy = (as_ps + ans_pns)/(as_ps + ans_pns + as_pns + ans_ps)  # Accuracy. Update this.
    precision = ans_pns/(ans_pns + as_pns)  # Precision. The positive class is 'spam.' Update this.
    recall = ans_pns/(ans_pns+ans_ps)  # Recall. The positive class is 'spam.' Update this.
    ...
    # I recommend you to use the confusion matrix and your
